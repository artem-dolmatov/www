...
<!--Форма заявки в автошколах
<form action="" method="post" id="form_id" name="form_id">
    <div><h1>Запись в автошколу</h1></div>
    <input type="text" name="name" placeholder="Ваше Имя...">
    <input type="text" name="phone" placeholder="Номер телефона...">
    <div id="messegeResultat"></div>
     <button type="submit" id="contact_form_submit" name="contact_submit" class="theme_button" onclick="AjaxFormRequest('messegeResultat', 'form_id', '/templates/send.php')">Отправить</button>
</form>-->
    
<br>     		
<!-- VK Widget -->
<div id="vk_groups" style="width:240px; float:left;"></div>
...
<div class="wrap" style="background:url('/templates/images/bgfooter.png') repeat-x top; padding:40px 0 10px 0;">
    ...
    <div style="float:left; width:190px;">
		...
		<li><a href="/kurs.php">Дополнительные Курсы</a></li>
...
?>
    ...
    <br clear="both"/><br/>
   <span style="font-size:12px;">2015-<?php echo date('Y');?> &copy; <a href="http://as72.ru">Автошколы Тюмени<br>
</div><!-- /wrap -->
</div>
...
-->
  ...
  jQuery(document).ready(function(){
    ...
    $(".around").corner('4px');
	$query = "DELETE FROM `my_sql_table` where surname='Тюмень'";

    ...
    <div class="ins_cont" style="width:100%;">
    	<div class="ins_inp" style="background: #b7c6d8; width:100%; height:200px;">
    		<div class="ins_photo" style="width:35%; height:200px; float: left; margin-left:1%;  ">
    			<img src="/ins_files/photos/3.jpg" alt="Автошколы Тюмени"  style="align:left; width:100%; height:90%; margin-top:4%;  border: 3px solid #5c7fa7; "/>
    		</div>
    	...
    	<img src="/ins_files/photos/9_0.png" alt="Автошколы Тюмени" style="width:100%; height:90%;">
    	 </div>
    	</div>
    	</div>
